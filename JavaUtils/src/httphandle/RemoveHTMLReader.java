	...
	public static class Test {
		...
		public static void main(String[] args) {
			try {
				...
				BufferedReader in = new BufferedReader(new RemoveHTMLReader(
				...
				System.err
						.println("Usage: java RemoveHTMLReader$Test <filename>");
			}
		}
	}
}

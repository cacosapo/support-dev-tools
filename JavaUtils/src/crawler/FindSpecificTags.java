...
public class FindSpecificTags {
	...
	public FindSpecificTags() {
		// TODO Auto-generated constructor stub
	}
	
	public FindSpecificTags(String url){
		try {
			MicrosoftConditionalCommentTagTypes.register();
			MasonTagTypes.register();
			source = new Source((new URL(url)).openConnection());
	...
	public static void main(String[] args) throws Exception {
		String sourceUrlString = "http://zbor.openet-telecom.lan/~tester3/newreport//PHONE.PHONE-AC.PHONE-AC-001//PHONE_PHONE_AC_001.act//RunDsdUnitTests_test.dsdu_PMATF_6000000/";
		if (args.length == 0)
		...
		MicrosoftConditionalCommentTagTypes.register();
		MasonTagTypes.register();
		Source source = new Source((new URL(sourceUrlString)).openConnection());
		System.out
				.println("\n*******************************************************************************\n");
		...
		displaySegments(source
				.getAllTags(StartTagType.XML_PROCESSING_INSTRUCTION));
		...
		// Note: The end of a PHP tag can not be reliably found without the use
		// of a PHP parser,
		// meaning any PHP tag found by this library is not guaranteed to have
		...
		displaySegments(source
				.getAllElements(MasonTagTypes.MASON_COMPONENT_CALLED_WITH_CONTENT));
		...
		displaySegmentsLinks(linkElements);
		
		for (Element element : linkElements) {
			System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
			if (element.getAttributeValue("href") == null || !element.getAttributeValue("href").contains("table"))
				continue;
			Source sourceTemp = new Source((new URL(sourceUrlString+element.getAttributeValue("href"))).openConnection());
			System.out.println();
			List<Element> linkElementsTemp = sourceTemp.getAllElements(HTMLElementName.A);
			displaySegmentsLinks(linkElementsTemp);
			System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
		}
	...
	private static void displaySegmentsLinks(
			List<? extends Element> linkElements) {
	...
	public List<String> getSegmentsLinks(
			List<? extends Element> linkElements) {
	 ...
	 * @return
	 */
	public List<Element> getAnchorTag() {
		return source.getAllElements(HTMLElementName.A);
	}
